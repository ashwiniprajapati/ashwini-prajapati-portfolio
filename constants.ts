...
export const PROFILE: ProfileData = {
  ...
  summary:
    "Results-driven software professional with 9+ years of experience in software development and project execution, including 5 years of hands-on expertise in Angular. Proven track record of delivering high-quality solutions using a variety of tools and technologies. Committed to leveraging my skills and strengths to contribute effectively to organizational goals while continuously striving for excellence and innovation in every phase of the project lifecycle.",
  experiences: [
    {
  ...
  projects: [
    {
      title: "Verizon - MyBiz",
      description:
        "An enterprise telecom portal for managing business accounts, services, and subscriptions. Leading the data tagging team across Angular and React repositories to enable accurate analytics and tracking.",
      techUsed: ["Angular", "React", "TypeScript", "JavaScript", "Git", "Jira"],
    },
    {
      title: "Dell – APEX Custom Experience Portal",
      description:
        "Platform for internal sales representatives to visualize all pricing options to generate booking packages and contracts. Responsible for UI and API integration.",
      techUsed: [
        "Angular 16",
        "TypeScript",
        "JavaScript",
        "Prometheus web components",
        "CSS",
    ...
    },
    {
      ...
      description:
        "A social word game where players take the last letter of a word to start a new one. Cross-platform mobile application implementation.",
      techUsed: ["Angular 6", "Cordova", "PHP (Slim Framework)"],
    },
    {
      title: "NicoERP",
      description:
        "Custom ERP software covering Manufacturing, HR, Procurement, QC, Sales, and Inventory Reports.",
